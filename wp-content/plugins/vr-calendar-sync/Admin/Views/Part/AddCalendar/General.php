                                ...
                                <td>
                                    <table class="form-table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="calendar_links[name][]" value="<?php echo $clink->name; ?>" class="large-text" placeholder="Name" />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="calendar_links[url][]" value="<?php echo $clink->url; ?>" class="large-text" placeholder="ics/ical Link" />
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
