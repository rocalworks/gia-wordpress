...
class VRCalendarShortcode extends VRCShortcode {
    ...
    function shortcode_handler($atts, $content = "") {
        ...
        $output = <<<E
<div class="vrc vrc-calendar vrc-calendar-booking-no vrc-calendar-{$cal_data->calendar_layout_options['size']} vrc-calendar-id-{$cal_data->calendar_id}" id="vrc-calendar-uid-{$uid}">
    <div class=" calendar-header">
        <div>
            <div class="calendar-info">$lang_update {$last_sync_date}</div>
            <div class="pull-left">
